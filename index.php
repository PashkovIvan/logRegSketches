    ...
    <div class="container">
        ...
        <form id="logForm" action="/login.php">
            ...
            <div class="form-floating">
                <input type="email" required class="form-control" id="logEmail" placeholder="ivanov.i@mail.ru"
                       value="test@test.test" name="<?= EMAIL_INPUT_NAME ?>">
                <label for="logEmail">Email</label>
            </div>
            <div class="form-floating">
                <input type="password" required class="form-control" id="logPassword" placeholder="Пароль" value="Test"
        ...
        <form id="regForm" style="display: none" action="/register.php">
            <!-- Form -->
            <div class="form-floating">
                <input type="text" required class="form-control" id="regFirstName" placeholder="Иван" value="Test"
                       name="<?= FIRST_NAME_INPUT_NAME ?>">
                <label for="regFirstName">Имя</label>
            </div>
            <div class="form-floating">
                <input type="text" required class="form-control" id="regLastName" placeholder="Иванов" value="Test"
                       name="<?= LAST_NAME_INPUT_NAME ?>">
                <label for="regLastName">Фамилия</label>
            </div>
            <div class="form-floating">
                <input type="email" required class="form-control" id="regEmail" placeholder="ivanov.i@mail.ru"
                       value="test@test.test" name="<?= EMAIL_INPUT_NAME ?>">
                <label for="regEmail">Email</label>
            </div>
            <div class="form-floating">
                <input type="password" required class="form-control" id="regPassword" placeholder="Пароль" value="Test"
                       name="<?= PASSWORD_INPUT_NAME ?>">
                <label for="regPassword">Пароль</label>
            </div>
            <div class="form-floating">
                <input type="password" required class="form-control" id="regPasswordRepeat"
                       placeholder="Повторите пароль" value="Test" name="<?= PASSWORD_REPEAT_INPUT_NAME ?>">
